...
- Ensure the recording will capture your entire desktop, including VS Code and browser.
...
**After the exam:**
- When Zoom ends, the recording will be saved locally.  
- Upload the recording to SharePoint by **13:00**.  
- If you encounter any difficulties using SharePoint or OneDrive, please let me know and I will provide you with an alternative upload link for your recording.
